...
const Home = () => {
  ...
  // Fetch genres when selectedLanguage changes
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/genre/movie/list?api_key=${API_KEY}&language=${selectedLanguage}`
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    ...
    fetchMovies();
  }, [searchTerm, page, selectedLanguage]);
